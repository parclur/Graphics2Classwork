...
/*
	...
	drawPhongMulti_tangentBasis_fs4x.glsl
	Calculate and output Phong shading model for multiple lights using full 
		tangent basis passed from previous shader.
...
void main()
{
	// DUMMY OUTPUT: all fragments are FADED RED
	rtFragColor = vec4(1.0, 0.5, 0.5, 1.0);
