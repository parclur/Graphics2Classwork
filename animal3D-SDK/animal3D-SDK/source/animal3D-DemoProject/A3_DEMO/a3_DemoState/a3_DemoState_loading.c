...
//	a3ui32 i, j;
	...
	a3framebufferCreate(fbo, "fbo:scene", 1, colorType_scene, depthType_scene, demoState->frameWidth, demoState->frameHeight);

	fbo = demoState->fbo_composite;
	a3framebufferCreate(fbo, "fbo:composite", 1, colorType_comp, a3fbo_depthDisable, demoState->frameWidth, demoState->frameHeight);

	fbo = demoState->fbo_shadowmap;
	a3framebufferCreate(fbo, "fbo:shadowmap", 0, a3fbo_colorDisable, a3fbo_depth24, shadowMapSz, shadowMapSz);
