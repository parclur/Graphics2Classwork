...
#ifndef __ANIMAL3D_HIERARCHY_H
#define __ANIMAL3D_HIERARCHY_H
...
//-----------------------------------------------------------------------------
	...
	inline a3i32 a3hierarchyCreate(a3_Hierarchy *hierarchy_out, const a3ui32 numNodes, const a3byte **names_opt);
	...
	//	return: -1 if invalid params
	inline a3i32 a3hierarchySetNode(const a3_Hierarchy *hierarchy, const a3ui32 index, const a3i32 parentIndex, const a3byte name[a3node_nameSize]);
	...
	inline a3i32 a3hierarchyGetNodeIndex(const a3_Hierarchy *hierarchy, const a3byte name[a3node_nameSize]);
	...
	//	return: -1 if invalid params
	inline a3i32 a3hierarchyGetNodeNames(const a3byte *nameList_out[], const a3_Hierarchy *hierarchy);
	...
	//	return: -1 if invalid params
	inline a3i32 a3hierarchyIsParentNode(const a3_Hierarchy *hierarchy, const a3ui32 parentIndex, const a3ui32 otherIndex);
	...
	//	return: -1 if invalid params
	inline a3i32 a3hierarchyIsChildNode(const a3_Hierarchy *hierarchy, const a3ui32 childIndex, const a3ui32 otherIndex);
	...
	//	return: boolean, 1 if the node is a parent of the other; 0 if not
	//	return: -1 if invalid params
	inline a3i32 a3hierarchyIsSiblingNode(const a3_Hierarchy *hierarchy, const a3ui32 siblingIndex, const a3ui32 otherIndex);
	...
	//	return: boolean, 1 if the node is a parent of the other; 0 if not
	//	return: -1 if invalid params
	inline a3i32 a3hierarchyIsAncestorNode(const a3_Hierarchy *hierarchy, const a3ui32 ancestorIndex, const a3ui32 otherIndex);
	...
	//	return: boolean, 1 if the node is a parent of the other; 0 if not
	//	return: -1 if invalid params
	inline a3i32 a3hierarchyIsDescendantNode(const a3_Hierarchy *hierarchy, const a3ui32 descendantIndex, const a3ui32 otherIndex);
	...
	//	return: 0 if failed
	//	return: -1 if invalid params
	inline a3i32 a3hierarchySaveBinary(const a3_Hierarchy *hierarchy, const a3_FileStream *fileStream);
	...
	//	return: 0 if failed
	//	return: -1 if invalid params
	inline a3i32 a3hierarchyLoadBinary(a3_Hierarchy *hierarchy, const a3_FileStream *fileStream);
	...
	//	return: 0 if failed
	//	return: -1 if invalid params
	inline a3i32 a3hierarchyCopyToString(const a3_Hierarchy *hierarchy, a3byte *str);
	...
	//	return: 0 if failed
	//	return: -1 if invalid params
	inline a3i32 a3hierarchyCopyFromString(a3_Hierarchy *hierarchy, const a3byte *str);

	// A3: Get hierarchy stream size.
	//	param hierarchy: non-null pointer to initialized hierarchy
	//	return: number of bytes required to store hierarchy in string
	//	return: -1 if invalid param
	inline a3i32 a3hierarchyGetStringSize(const a3_Hierarchy *hierarchy);

	// A3: Release hierarchy.
	//	param hierarchy: non-null pointer to initialized hierarchy
	//	return: 1 if success
	//	return: -1 if invalid param
	inline a3i32 a3hierarchyRelease(a3_Hierarchy *hierarchy);
